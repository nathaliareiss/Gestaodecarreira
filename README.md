...
O foco é dar uma visão clara da carreira, com tempo trabalhado, afastamentos e próximos marcos.
...
- `backend/.env.example`: exemplo com SMTP e dados de ambiente
...
2. O backend salva os dados e envia o e-mail de confirmação.
