    ...
    <main className="page-shell">
      ...
      <section className="notes-grid">
        ...
        <article className="note-card">
          ...
          <ul>
            <li>Modelos guardam dados.</li>
            <li>Services fazem regra de negocio.</li>
            <li>Schemas definem entrada e saida.</li>
            <li>Controller atende CLI.</li>
            <li>API atende o front.</li>
          </ul>
        </article>
      </section>
    </main>
