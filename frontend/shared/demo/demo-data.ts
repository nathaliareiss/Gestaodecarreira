...
export const DEMO_HISTORICO: HistoricoFuncionalAnalise = {
  ...
  sexo: "feminino",
  categoria_previdenciaria: "geral",
  ...
  data_aposentadoria_prevista: "2048-08-12",
  dias_trabalhados: 5480,
  dias_totais_ate_aposentadoria: 13566,
  percentual_trabalhado: 40.4,
  percentual_restante: 59.6,
  proxima_progressao_prevista: "2026-09-01",
  proxima_promocao_prevista: "2027-03-01",
  resumo_grafico: {
    tempo_trabalhado_dias: 5480,
    tempo_restante_dias: 8086,
    percentual_trabalhado: 40.4,
    percentual_restante: 59.6,
    eventos_totais: 5,
    eventos_por_status: {
  ...
  resumo_aposentadoria: {
    tempo_restante_dias: 8086,
    idade_na_aposentadoria_anos: 60,
    idade_por_tempo_servico_anos: 49,
    idade_minima_governo_anos: 60,
    data_por_tempo_servico: "2038-02-01",
    data_por_idade_minima: "2048-08-12",
    data_prevista: "2048-08-12",
    nivel_previsto: "V",
    grau_previsto: "H",
    observacao:
      "Projeção estimativa baseada nos interstícios da Lei 15.293/2004. Progressão e promoção dependem das avaliações obtidas, da titulação mínima e da análise do processo funcional.",
  },
  ...
  ferias_arquivo_nome: "ferias-exemplo.pdf",
  ferias_resumo: {
    periodos_totais: 2,
    dias_totais_usados: 35,
    dias_por_tipo: {
      regular: 20,
      premium: 15,
    },
    ...
    proxima_ferias_inicio: "2026-11-11",
    proxima_ferias_fim: "2026-12-02",
    proxima_ferias_tipo: "regular",
  },
  ferias: [
    {
      tipo: "regular",
      ...
      data_fim: "2026-01-02",
      dias_contabilizados: 10,
      dias_corridos: 16,
      regra_contagem: "dias_uteis",
      observacao: "Férias regulamentares importadas do Portal do Servidor.",
    },
    {
      tipo: "premium",
      data_inicio: "2026-04-17",
      data_fim: "2026-05-01",
      dias_contabilizados: 15,
      dias_corridos: 15,
      regra_contagem: "dias_corridos",
      observacao: "Férias-prêmio importadas do Portal do Servidor.",
    },
  ],
  eventos: [
    {
