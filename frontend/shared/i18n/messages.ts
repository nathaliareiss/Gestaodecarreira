...
export const LOCALE_TEXTS: Record<SiteLanguage, LocaleTexts> = {
  "pt-BR": {
    ...
    finance: {
      ...
      manualTokenReminderText:
        "Se o assistente não abrir sozinho, gere um token temporário, cole na janela do assistente e pressione Enter.",
      ...
      assistantStep1: "Instale o assistente",
  ...
  en: {
    ...
    finance: {
      ...
      manualTokenModalHint: "Open the assistant on your computer and paste this token.",
