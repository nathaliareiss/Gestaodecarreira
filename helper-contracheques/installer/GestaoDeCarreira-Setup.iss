...
AppPublisherURL=https://portaldoservidor.mg.gov.br/
AppSupportURL=https://portaldoservidor.mg.gov.br/
AppUpdatesURL=https://portaldoservidor.mg.gov.br/
DefaultDirName={localappdata}\GestaoDeCarreira\Assistente
DefaultGroupName={#AppName}
DisableDirPage=yes
DisableProgramGroupPage=yes
OutputBaseFilename=GestaoDeCarreira-Setup
